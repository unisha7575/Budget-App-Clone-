import 'package:budget_monthlay_app_clone/theme/colors.dart';
import 'package:circle_progress_bar/circle_progress_bar.dart';
import 'package:fl_chart/fl_chart.dart';
import 'package:flutter/material.dart';

import '../theme/categarey.dart';
import '../theme/chartLine.dart';
import '../theme/marchant_list.dart';
    ...
    return Center(
      child: Column(
        children: [
          ...
          Text(
            'By this last month ,you spent \n slightly higher(\$2450)',
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                          ...
                          style: TextStyle(
                              fontSize: 16, fontWeight: FontWeight.w600,color: Colors.black.withOpacity(0.5)),
                        ),
                        SizedBox(height: 15,),
                        Container(
                          width: 80,
                          ...
                          child: Center(child: Text('on track',style: TextStyle(fontSize: 13,fontWeight: FontWeight.w600),)),
                        )
                      ],
